...
class MenuHelper
{
    ...
    /**
     * Menu lain (optional)
     * Kamu boleh hapus ini, tapi kubiarkan dulu
     * sebagai contoh format menu tambahan.
     */
    ...
    public static function getMenuGroups()
    {
        ...
        if ($role === 'admin') {
            $groups = self::getAdminMenu();
        } elseif ($role === 'user') {
            $groups = self::getUserMenu();
        } else {
            // Guest (belum login)
            $groups = [
                [
        ...
        // Others hanya muncul jika sudah login
        if ($role !== 'guest') {
            $groups[] = [
                'title' => 'Others',
